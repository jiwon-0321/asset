...
async function buildLivePriceSnapshot({ rootDir, fetchImpl = fetch, portfolioData = null }) {
  if (typeof fetchImpl !== "function") {
    throw new Error("fetch 구현을 찾지 못했습니다.");
  }

  const portfolio = portfolioData ? structuredClone(portfolioData) : await loadPortfolio(rootDir);
