...
const assetStrategyPlaybookData = window.AssetStrategyPlaybookData;
const assetStrategyPlaybookShell = window.AssetStrategyPlaybookShell;
...
if (!assetStrategyPlaybookData) {
  throw new Error("AssetStrategyPlaybookData is missing. Load client/strategy-playbook-data.js before app.js.");
}

if (!assetStrategyPlaybookShell) {
  throw new Error("AssetStrategyPlaybookShell is missing. Load client/strategy-playbook-shell.js before app.js.");
}
...
const strategyPlaybookDataHelpers = assetStrategyPlaybookData.createStrategyPlaybookDataHelpers({
  normalizeTradeStrategyStage,
});

const strategyPlaybookShellHelpers = assetStrategyPlaybookShell.createStrategyPlaybookShellHelpers({
  escapeHtml,
});
...
function renderStrategy(strategy) {
  ...
  const normalizedStrategy = strategyPlaybookDataHelpers.normalizeStrategyPlaybook(strategy);
  strategyPlaybookShellHelpers.renderStrategyPlaybook(container, normalizedStrategy);
}
